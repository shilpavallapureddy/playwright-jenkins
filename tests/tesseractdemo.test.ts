...
test("Tesseract - Image to text", async ({ page }) => {
    ...
    //await page.waitForSelector(".jsx-98ac5e1b53154d9c whitecall_icon jdicon mr-10 callNowAnchor");
    //await page.click('#best_deal_div >> text=X', { force: true, delay: 2000 });
    const images = await page.$$("span[class='jsx-98ac5e1b53154d9c callcontent callNowAnchor']");
